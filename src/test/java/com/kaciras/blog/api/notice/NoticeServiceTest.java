...
final class NoticeServiceTest {
	...
	void getAll() {
		...
		assertThat(list.getFirst().getType()).isEqualTo(ActivityType.DISCUSSION);
		assertThat(list.getFirst().getTime()).isNotNull();
		assertThat(list.getFirst().getData()).isNotNull();
	}
